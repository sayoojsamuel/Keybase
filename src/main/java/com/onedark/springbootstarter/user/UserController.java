...
public class UserController {
	...
	@RequestMapping(method=RequestMethod.PUT,value="/users/{id}/getkeys/{password}")
	public String generateKeys(@RequestBody User user, @PathVariable String id, @PathVariable String password) throws NoSuchAlgorithmException, NoSuchProviderException, IOException {
		return userService.getKeys(user, id, password);
	}
